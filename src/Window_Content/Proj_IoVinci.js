  ...
  return (
        <div className='iovinci_content'>
          <div className='iovinci_imgs'>
            <a href="https://www.disruptcampus-toulouse.fr/" target="_blank"><img className='iovinci_img' src={IMG_SRC+'logo-disrupt-campus.png'} alt="Logo DCT"/></a>
            <a href="https://www.vinci.com/vinci.nsf/fr/index.htm" target="_blank"><img className='iovinci_img' src={IMG_SRC+'logo-vinci.png'} alt="Logo Vinci Facilities"/></a>
          </div>
                ...
                {tab.activeTab === 0 && (
                  <div className="iovinci_overview" style={{ height: 'auto' }}>
                    <div className="iovinci_p1">
                      <div className="iovinci_imgcont"><img className="iovinci_p1_img" src={IMG_SRC+'grp.jpg'}/></div> 
                ...
                {tab.activeTab === 1 && (
                  <div style={{ height: 'auto' }}>
                    <div className="iovinci_p2">
                      ...
                      <div className="iovinci_imgcont2"><img className="iovinci_p2_img" src={IMG_SRC+'capt.jpg'}/></div>
                    </div>
                  </div>
                )}
                {tab.activeTab === 2 && (
                    <div style={{ height: 'auto' }}>
                      ...
                      <div className="iovinci_imgcont3"><img className="iovinci_p3_img" src={IMG_SRC+'spring-boot-logo.png'}/></div>
